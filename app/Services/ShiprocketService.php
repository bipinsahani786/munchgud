...
class ShiprocketService
{
    ...
    public function createOrder(Order $order): array
    {
        ...
        $payload = [
            ...
            'billing_last_name'       => '',
            'billing_address'         => substr(trim($order->shipping_line1), 0, 50),
            'billing_address_2'       => substr(trim(($order->shipping_line2 ? $order->shipping_line2 . ', ' : '') . $order->shipping_landmark), 0, 50),
            'billing_city'            => substr(trim($order->shipping_city), 0, 50),
