    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 mb-24">
            ...
            <div class="space-y-4 relative w-full overflow-hidden">
                ...
                <!-- Left-Side Product Description & FAQs Toggle Card (Desktop ONLY) -->
                <div class="mt-8 hidden lg:block bg-white rounded-3xl p-6 sm:p-8 border border-mg-dark/5 shadow-sm" x-data="{ tab: 'description' }">
            ...
            <div class="flex flex-col">
                ...
                <!-- Mobile ONLY Product Description & FAQs Toggle Card -->
                <div class="mt-8 block lg:hidden bg-white rounded-3xl p-6 sm:p-8 border border-mg-dark/5 shadow-sm" x-data="{ tab: 'description' }">
                    <!-- Toggle Buttons Header -->
                    <div class="flex items-center gap-2 p-1.5 bg-mg-cream/70 rounded-2xl mb-6 border border-mg-dark/5">
                        <button type="button" @click="tab = 'description'" 
                                class="flex-1 py-2.5 px-4 rounded-xl text-sm font-bold transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer"
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="group bg-white rounded-3xl border border-mg-dark/[0.04] overflow-hidden hover:-translate-y-2 hover:shadow-xl transition-all duration-300">
                    <a href="{{ route('products.show', $rp->slug) }}" class="relative aspect-square bg-gradient-to-br from-mg-cream to-white flex items-center justify-center overflow-hidden block">
                        ...
                        @endif
                        @if($rp->secondary_badge_text)
                            <span class="absolute top-4 right-4 bg-mg-green text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">{{ $rp->secondary_badge_text }}</span>
                        @endif
                    </a>
