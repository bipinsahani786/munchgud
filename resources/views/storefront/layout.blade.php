            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-2.5">
                        ...
                        <a href="mailto:support@munchgud.com" class="text-sm text-white/40 hover:text-mg-leaf transition">support@munchgud.com</a>
                    </li>
                    <li class="flex items-start gap-2.5">
                        ...
                        <span class="text-sm text-white/35 leading-snug">Darbhanga, Bihar<br>India — 846 004</span>
                    </li>
                    <li>
                        <a href="https://wa.me/919999999999" target="_blank" rel="noopener" class="inline-flex items-center gap-2 text-xs font-semibold bg-[#25D366]/10 text-[#25D366] border border-[#25D366]/20 rounded-full px-3.5 py-2 hover:bg-[#25D366]/20 transition">
