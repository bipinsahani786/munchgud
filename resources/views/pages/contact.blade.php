    ...
    <div class="bg-munch-cream min-h-screen">
        ...
        <div class="relative bg-munch-900 py-20 overflow-hidden text-center">
            <div class="absolute inset-0 opacity-10"
                style="background-image: radial-gradient(#E07B2A 1px, transparent 1px); background-size: 40px 40px;"></div>
            <div class="relative z-10 max-w-3xl mx-auto px-4">
                <span class="text-munch-accent uppercase tracking-widest font-bold text-xs mb-3 block">We're Here For
                    You</span>
                <h1 class="text-4xl md:text-5xl font-serif text-white mb-4">Get In Touch</h1>
                <p class="text-munch-200 font-light text-lg max-w-xl mx-auto">Whether it's a question, feedback, or just
                    saying hi — we'd love to hear from you!</p>
            </div>
        </div>
        ...
        <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 py-16">
            <div class="grid lg:grid-cols-3 gap-10 xl:gap-14">
                ...
                <div class="space-y-5">
                    ...
                    {{-- Email --}}
                    <div
                        class="bg-white rounded-2xl border border-munch-100 p-6 premium-shadow flex items-start gap-4 hover:border-mg-green/20 transition group">
                        <div
                            class="w-12 h-12 bg-mg-green/10 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-mg-green/15 transition">
                            <svg class="w-5 h-5 text-mg-green" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <a href="mailto:{{ $global_settings['store_email'] ?? 'support@munchgud.com' }}"
                                class="text-munch-900 font-semibold text-sm hover:text-mg-green transition">{{
                    ...
                    {{-- WhatsApp --}}
                    <div
                        class="bg-white rounded-2xl border border-munch-100 p-6 premium-shadow flex items-start gap-4 hover:border-[#25D366]/30 transition group">
                        <div
                            class="w-12 h-12 bg-[#25D366]/10 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-[#25D366]/15 transition">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-munch-900 font-semibold text-sm">
                                {{ $global_settings['company_city'] ?? 'Darbhanga' }},
                                {{ $global_settings['company_state'] ?? 'Bihar' }}</p>
                            <p class="text-xs text-munch-400 mt-1 font-medium">India —
                                {{ $global_settings['company_pincode'] ?? '846 004' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl border border-munch-100 p-5">
                        ...
                        <div class="space-y-2">
                            <a href="{{ route('faq') }}"
                                class="flex items-center gap-2.5 text-sm text-munch-700 hover:text-mg-green font-medium transition group">
                                <svg class="w-4 h-4 text-mg-green/50 group-hover:text-mg-green transition" fill="none"
                            ...
                            @auth
                                <a href="{{ route('account.tickets.create') }}"
                                    class="flex items-center gap-2.5 text-sm text-mg-green font-semibold hover:underline transition group">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-3xl border border-munch-100 premium-shadow p-8 md:p-10">
                        ...
                        <p class="text-sm text-munch-500 mb-8 font-light">Fill out the form and our team will get back to
                            you within 24 hours.</p>

                        {{-- Success Message --}}
                        @if(session('success'))
                            <div
                                class="flex items-start gap-3 bg-green-50 border border-green-200/70 text-green-800 rounded-2xl p-5 mb-6">
                        ...
                        <form action="{{ route('contact.send') }}" method="POST" class="space-y-6"
                            ...
                            <div class="grid sm:grid-cols-2 gap-5">
                                <div>
                                    <label for="name"
                                        class="block text-[11px] font-bold uppercase tracking-widest text-munch-600 mb-2">Full
                                        Name *</label>
                                ...
                                <div>
                                    <label for="email"
                                        class="block text-[11px] font-bold uppercase tracking-widest text-munch-600 mb-2">Email
                                        Address *</label>
                            ...
                            <div>
                                <label for="phone"
                                    class="block text-[11px] font-bold uppercase tracking-widest text-munch-600 mb-2">Phone
                                    Number <span class="text-munch-400 normal-case font-normal">(optional)</span></label>
                            ...
                            <div>
                                <label for="subject"
                                    class="block text-[11px] font-bold uppercase tracking-widest text-munch-600 mb-2">Subject
                                    *</label>
                                <select id="subject" name="subject" required
                                    ...
                                    <option value="" disabled {{ old('subject') ? '' : 'selected' }}>Select a topic…
                                    </option>
                                    <option value="Order Issue" {{ old('subject') == 'Order Issue' ? 'selected' : '' }}>Order
                                        Issue / Delay</option>
                                    <option value="Product Query" {{ old('subject') == 'Product Query' ? 'selected' : '' }}>
                                    ...
                                    <option value="Partnership" {{ old('subject') == 'Partnership' ? 'selected' : '' }}>
                                        Partnership / Collaboration</option>
                            ...
                            <div>
                                <label for="order_number"
                                    class="block text-[11px] font-bold uppercase tracking-widest text-munch-600 mb-2">Order
                                    Number <span class="text-munch-400 normal-case font-normal">(if
                            ...
                            <div>
                                <label for="message"
                                    class="block text-[11px] font-bold uppercase tracking-widest text-munch-600 mb-2">Your
                                    Message *</label>
                            ...
                            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                <button type="submit" :disabled="submitting" class="btn-primary py-3.5 px-8 text-[13px]"
                                    ...
                                    <svg x-show="submitting" class="w-4 h-4 animate-spin" fill="none" stroke="currentColor"
                                        ...
                                        <path stroke-linecap="round" d="M12 2a10 10 0 110 20A10 10 0 0112 2zm0 4v4l3 3" />
                                    </svg>
                                    <span x-show="!submitting">Send Message →</span>
                                    <span x-show="submitting" x-cloak>Sending…</span>
                                </button>
                                <p class="text-xs text-munch-500 font-light">
                                    <svg class="w-3.5 h-3.5 inline-block mr-1 text-mg-green" fill="none"
                                        stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div class="bg-munch-900/5 border-t border-munch-200 py-16">
            <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 text-center">
                ...
                <p class="text-munch-600 font-light mb-10 max-w-md mx-auto text-sm">Our makhanas are sourced, roasted, and
                    packed in {{ $global_settings['company_city'] ?? 'Darbhanga' }} — the makhana capital of the world.</p>
                <div class="rounded-3xl overflow-hidden border border-munch-200 premium-shadow max-w-4xl mx-auto">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15122.92087579797!2d73.73877965!3d18.6312003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2ba1e52f3b7d7%3A0x21052ab2f9eb2f81!2sPunawale%2C%20Pimpri-Chinchwad%2C%20Maharashtra%20411033!5e0!3m2!1sen!2sin!4v1780644545334!5m2!1sen!2sin"
