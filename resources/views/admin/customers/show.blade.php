            ...
            <form action="{{ route('admin.customers.change-password', $user) }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ showPass: false }">
                        <input :type="showPass ? 'text' : 'password'" name="password" required placeholder="Minimum 6 characters"
                               class="w-full border border-gray-200 rounded-xl pl-4 pr-11 py-2 text-sm focus:ring-2 focus:ring-emerald-500/20 outline-none">
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ showConfirmPass: false }">
                        <input :type="showConfirmPass ? 'text' : 'password'" name="password_confirmation" required placeholder="Re-enter password"
                               class="w-full border border-gray-200 rounded-xl pl-4 pr-11 py-2 text-sm focus:ring-2 focus:ring-emerald-500/20 outline-none">
