                    ...
                    <div class="p-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="secondary_badge_text" value="{{ old('secondary_badge_text', $product->secondary_badge_text) }}" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition" placeholder="e.g. BUY 1 GET 1 FREE">
