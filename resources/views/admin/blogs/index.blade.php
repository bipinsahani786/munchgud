...
<div class="mb-8 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
    ...
    <div class="flex items-center gap-3">
        <a href="{{ route('admin.blogs.create') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-mg-green text-white text-sm font-bold rounded-xl hover:bg-mg-green-dark transition shadow-sm border border-transparent">
