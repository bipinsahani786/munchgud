        ...
        <nav class="flex-1 overflow-y-auto py-5 px-3 sidebar-scroll space-y-6">
            ...
            <div>
                ...
                <ul class="space-y-0.5">
                    ...
                    <li>
                        <a href="{{ route('admin.inquiries.index') }}" class="nav-item {{ request()->routeIs('admin.inquiries.*') ? 'nav-item-active' : 'nav-item-inactive' }}">
                            ...
                            @if($unreadInquiries > 0)
                                <span class="ml-auto bg-blue-500/20 text-blue-400 text-[10px] font-bold px-1.5 py-0.5 rounded-md">{{ $unreadInquiries }}</span>
                            @endif
                        </a>
                    </li>
                </ul>
            ...
            <div>
                ...
                <ul class="space-y-0.5">
                    <li>
                        <a href="{{ route('admin.pages.index') }}" class="nav-item {{ request()->routeIs('admin.pages.*') ? 'nav-item-active' : 'nav-item-inactive' }}">
                            <svg class="nav-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10l6 6v10a2 2 0 01-2 2z"/><path stroke-linecap="round" stroke-linejoin="round" d="M13 2v7h7"/></svg>
                            Pages / CMS
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.faqs.index') }}" class="nav-item {{ request()->routeIs('admin.faqs.*') ? 'nav-item-active' : 'nav-item-inactive' }}">
                            <svg class="nav-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                            FAQs
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('admin.zones.index') }}" class="nav-item {{ request()->routeIs('admin.zones.*') ? 'nav-item-active' : 'nav-item-inactive' }}">
                            <svg class="nav-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/></svg>
                            Delivery Zones
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.system.tools') }}" class="nav-item {{ request()->routeIs('admin.system.tools') ? 'nav-item-active' : 'nav-item-inactive' }}">
                    ...
                    <li>
                        <a href="{{ route('admin.system.logs') }}" class="nav-item {{ request()->routeIs('admin.system.logs') ? 'nav-item-active' : 'nav-item-inactive' }}">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="relative" x-data="{ open: false }" @click.away="open = false">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" x-cloak class="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-200/80 py-1.5 divide-y divide-gray-100">
                            ...
                            <div class="py-1.5">
                                <a href="{{ route('admin.profile') }}" class="flex items-center gap-2.5 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition">
