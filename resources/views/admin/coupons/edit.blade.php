            ...
            <div class="space-y-6">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <input type="checkbox" name="is_visible" id="is_visible" value="1" {{ old('is_visible', $coupon->is_visible) ? 'checked' : '' }} class="rounded border-gray-300 text-emerald-600 focus:ring-emerald-600">
